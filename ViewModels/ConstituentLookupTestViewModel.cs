    ...
    public sealed class ConstituentLookupTestViewModel : INotifyPropertyChanged
    {
        ...
        private async Task SearchAsync()
        {
            ...
            catch (InvalidOperationException ex)
            {
                ...
                UiError.Show(ex, title: "Not Authorized", context: "ConstituentLookupTestViewModel.SearchAsync", icon: MessageBoxImage.Warning);
            }
            catch (Exception ex)
            {
                StatusText = "Error: " + ex.Message;
                UiError.Show(ex, title: "Error", context: "ConstituentLookupTestViewModel.SearchAsync", message: "Error during search.", owner: null);
            }
            finally
            {
                IsBusy = false;
